...
BASE_RATINGS = {
    "count": 1930,   # 👈 عدّل هذا الرقم: عدد المقيمين الافتراضي القديم
...
async def show_statistics(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # 👇 التحقق هل هذا المستخدم قيّم سابقًا
...
async def save_rating(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔁 لو مافي معلومات كافية في user_data نحاول من bot_data
    ...
    # 🔁 لو ما زالت البيانات غير واضحة، ونفس رسالة التقييم جايه من مجموعة، نستخدم عنوان المجموعة الفعلي
