...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔹 رسالة ختامية فيها أزرار رجوع
        ...
        # ✅ نفس التنسيق بالضبط مثل handle_suggestion
        prompt_block = (
            "💬 أهلاً بك في *مركز الدعم الفني* لبرنامج GO.\n\n"
            "✉️ يرجى كتابة استفسارك أو ملاحظتك، مع إمكانية إرفاق "
            ...
            "_ℹ️ إذا احتجت إرسال أكثر من ملف يمكنك إرسالها في استفسارات منفصلة\n"
            "حتى لا تضيع المرفقات أو يتم تجاهل بعضها._\n\n"
            "`يتم الاحتفاظ بهذه الجلسة مؤقتاً لمتابعة رد فريق GO`\n"
            f"`⏳ سيتم حذف هذه الجلسة تلقائيًا بعد 15 دقيقة ({delete_time} / 🇸🇦)`"
        )
