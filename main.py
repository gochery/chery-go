...
async def handle_manualcar(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user_name = query.from_user.full_name  # 🔄 نقل هذا السطر لأعلى
    ...
    if match.empty:
        caption = get_manual_not_available_message(user_name, delete_time)
...
def get_manual_not_available_message(user_name: str, delete_time: str) -> str:
    return (
