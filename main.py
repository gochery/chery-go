...
# ✅ تحميل بيانات # ✅ تحميل بيانات Excel
try:
    ...
    df_group_logs = excel_data.get("group_logs", pd.DataFrame())
    ...
    # ✅ تحميل شيت ratings (إن وجد) لتعبئة قائمة RATED_USERS
    try:
        ...
        logging.warning(f"[RATINGS INIT] فشل تحميل قائمة المقيمين من الإكسل: {e}")
        RATED_USERS = set()
