...
async def car_choice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔙 أزرار الرجوع من شاشة اختيار الكيلو
    user_store = context.user_data.get(user_id, {})
    brand = user_store.get("brand")
    if brand:
    ...
    await log_event(update, f"اختار {car} لمسافات الصيانة الدورية")
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "parts":
        ...
        # 🔹 رسالة ختامية فيها أزرار رجوع (مثل المراكز والمتاجر والأعطال)
