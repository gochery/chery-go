...
BASE_RATINGS = {
    "count": 3744,   # 👈 عدّل هذا الرقم: عدد المقيمين الافتراضي القديم
    "avg": 4.9,     # 👈 متوسط التقييم القديم (من 1 إلى 4)
}
...
initial_branches = {
    ...
    "MG": [],
    "جيتور": [],
    "أومودا": ["العربات الفاخرة"],
    "BYD": ["شركة الفطيم"],
    "سواسيت": ["سير الشرق للسيارات"],
    "جايكو": ["العربات الفاخرة"],
}
...
BRAND_CONTACTS = {
    # سنابل الحديثة – الوكيل الرئيسي لشيري وإكسيد
    "سنابل الحديثة": {
