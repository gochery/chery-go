...
application.add_handler(CallbackQueryHandler(lambda update, context: _send_independent_results(update, context, filter_type="ورشة"), pattern=r"^show_centers_\d+$"))
application.add_handler(CallbackQueryHandler(lambda update, context: _send_independent_results(update, context, filter_type="متجر"), pattern=r"^show_stores_\d+$"))
