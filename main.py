...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔹 رسالة ختامية فيها أزرار رجوع
        ...
        prompt_block = (
            ...
            "📎 <i>يمكنك إرفاق ملف واحد فقط (صورة – مستند – مقطع صوتي) مع كل استفسار.</i>\n\n"

            "⚠️ *لخدمتك بدقة أعلى:*\n"
            "🔹 <i>يرجى إضافة فئة السيارة – الموديل – سنة الصنع داخل نص الاستفسار.</i>\n\n"

            "🗂️ إذا رغبت بإرسال عدة ملفات، فضلاً أرسل كل ملف في استفسار مستقل.\n\n"
