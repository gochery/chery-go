            ...
            if media_list:
                try:
                    ...
                    if non_voice_media:
                        ...
                        # لا يوجد إلا voice فقط → نرسل كل الصوتيات ثم نص التوصية كرسالة مستقلة
                        ...
                        if fid:
                            first_voice_msg = await context.bot.send_voice(chat_id, fid)
                        ...
                        # بعد الصوتيات نرسل نص التوصية كرسالة مستقلة
                        text_msg = None
                        if html_text:
                            text_msg = await context.bot.send_message(
                                chat_id,
                        ...
                        # الرسالة المرشحة للتثبيت: نفضّل نص التوصية، ثم أول voice إن لم يوجد
                        sent_msg = text_msg or first_voice_msg
