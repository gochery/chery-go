...
async def handle_suggestion_reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ استخراج user_id حتى لو كان يحتوي على بادئة "reply"
    ...
    # 🔹 التحقق من وجود السجل قبل أي خطوة
    ...
    if not record:
        # طباعة debug للadmin لتحديد الخطأ بدقة
    ...
    if prefix == "reply":
        ...
        # 🔧 إصلاح مشكلة Button_data_invalid عبر استخدام المفتاح فقط بدون نص طويل
        keyboard = [
