...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔹 رسالة ختامية فيها أزرار رجوع
        ...
        prompt_block = (
            ...
            "<code><i>يرجى كتابة استفسارك أو ملاحظتك مع إمكانية إرفاق ملحق واحد فقط (صورة – ملف – مقطع صوتي).</i></code>\n\n"

            "⚠️ لخدمتك بشكل أدق:\n"
            "<code><i>فضلاً أضف فئة السيارة والموديل وسنة الصنع داخل الاستفسار لضمان دقة التشخيص.</i></code>\n\n"

            "ℹ️ إذا رغبت بإرسال عدة ملفات:\n"
            "<code><i>يمكنك إرسال كل ملف في استفسار مستقل للحفاظ على ترتيب المرفقات.</i></code>\n\n"

            "<code><i>يتم الاحتفاظ بهذه الجلسة مؤقتاً لمتابعة رد فريق GO.</i></code>\n"
            f"<code><i>⏳ سيتم حذف هذه الجلسة تلقائياً بعد 15 دقيقة ({delete_time} / 🇸🇦)</i></code>"
        )
