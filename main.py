...
async def show_statistics(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "<b>📌 الملخص العام</b>\n"
    f"👥 إجمالي عدد المستخدمين في مجتمع GO: <code>{total_users}</code>\n"
    f"🏡 عدد القروبات التي تعمل مع نظام GO: <code>{total_groups}</code>\n"
    f"🚀 عدد مرات استخدام نظام GO: <code>{total_go}</code>\n\n"
    f"{rating_info}\n\n"
