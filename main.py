...
async def handle_rating(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("⭐ - سيء", callback_data=f"ratingval_1_{user_id}")],
        ...
        [InlineKeyboardButton("⭐⭐⭐⭐⭐ - رائع جدًا", callback_data=f"ratingval_5_{user_id}")]
    ]
...
async def save_rating(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # ✅ إرسال رسالة شكر للمستخدم مع تنسيق جذاب
        thank_you_message = (
