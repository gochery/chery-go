...
async def send_cost(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🏷 تحديد البراند وتحويله الى مفتاح شركة التوكيل
    brand_raw = str(result.get("brand", "")).strip()

    # نفترض سنابل الحديثة بشكل افتراضي لكل السيارات القديمة (شيري / اكسيد)
    ...
    if brand_raw:
        ...
        # غيرها (شيري / اكسيد / الخ) تظل على سنابل الحديثة كافتراضي
