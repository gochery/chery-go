...
async def show_statistics(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if total_ratings_display > 0:
            ...
            rating_info = (
                "⭐ التقييمات:<br>"
                f'عدد المقيمين: <span style="color:#8e8e8e;">{total_ratings_display}</span><br>'
    ...
    text = (
        "<b>🧑‍💼 تقرير إحصائيات نظام GO</b><br>"
        f'للمستخدم: <span style="color:#8e8e8e;">{user_name_safe}</span><br><br>'

        "<b>📊 ملخص عام:</b><br>"
        f'👥 إجمالي المستخدمين: <span style="color:#8e8e8e;">{total_users}</span><br>'
        f'🏡 عدد القروبات المستخدمة للنظام: <span style="color:#8e8e8e;">{total_groups}</span><br>'
        f'🚀 إجمالي استخدام /go: <span style="color:#8e8e8e;">{total_go}</span><br><br>'

        f"{rating_info}<br><br>"

        "⏳ يتم تحديث هذه الأرقام تلقائيًا مع نشاط المستخدمين "
        f'(<span style="color:#8e8e8e;">{refresh_time} / 🇸🇦</span>)<br><br>'
