...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id < 0:
        ...
        user_block = f"🧑‍💼 مرحبا {user_name}"
        program_description = (
            "🤖 نظام GO المحدث لخدمة ملاك شيري برو واكسيد\n"
            "🔧 خدمة الاعطال الشائعة والحلول المقترحة لافضل تشخيص مبدئي\n"
            "🛠️ مركز الدعم الفني للاسئلة والاستفسارات الفنية\n"
            "⚙️ صيانة دورية قطع غيار دليل المالك مراكز خدمة ومتاجر معتمدة\n\n"
            "✅ تم تحديث النظام واضافة خدمات جديدة لجعل وصولك للمعلومة اسهل واسرع"
        )
        ...
        full_caption = (
           ...
           "💡 اضغط الزر بالاسفل لبدء خدمتك في الخاص عبر GO:\n\n"
           f"{delete_block}"
        )

        bot_username = context.bot.username
        link = f"https://t.me/{bot_username}?start=go"
        keyboard = [[InlineKeyboardButton("🚀 اضغط هنا لبدء خدمتك عبر GO", url=link)]]
