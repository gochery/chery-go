...
async def handle_rating(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("❤️ أحببته جداً", callback_data=f"ratingval_5_{user_id}")]
    ]
...
async def save_rating(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        thank_you_message = (
            f"🟦 شكراً لتقييمك،\n"
            f"`{user_name}`\n\n"
            f"`{rating_emojis.get(rating_value, '⭐')} | تقييمك: {rating_value} من 4`\n\n"
            ...
            try:
                await context.bot.send_message(
                    ...
                    text=(
                        ...
                        f"👥 المجموعة:\n`{group_name}`\n\n"
                        f"🆔 رقم المجموعة:\n`{group_id}`\n\n"
                        f"📝 التقييم:\n`{rating_emojis.get(rating_value, '⭐')} | {rating_value}/4`\n\n"
