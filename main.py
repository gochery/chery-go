...
async def send_part_image(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1) زر رجوع لقائمة تصنيفات القطع لنفس السيارة
    ...
    # 2) زر اختيار سيارة أخرى من نفس البراند (لو parts_brand متوفر)
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔹 رسائل القطع داخل التصنيف
        ...
        # ⚠️ تيليجرام لا يقبل رسالة بنص فارغ تمامًا → نستخدم حرف غير مرئي
        invisible_text = "\u200b"  # حرف مسافة غير مرئية، لن يظهر للمستخدم
